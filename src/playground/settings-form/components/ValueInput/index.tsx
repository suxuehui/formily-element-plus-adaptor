...
import { ElSelect as Select, ElPopover as Popover, ElButton as Button } from 'element-plus'
const {Option} = Select;
import { InputNumber, Input } from '@cps'
import { defineComponent } from 'vue'
// import { Codemirror } from 'vue-codemirror'
// import { javascript } from '@codemirror/lang-javascript'
import { TextWidget } from '@pg/prototypes'
import {MonacoInput} from '..';
        ...
        return () => {
          const renderEditor = () => {
            return (
              ...
              >
                <MonacoInput v-model={props.value} lang="json" onChange={value => emit('change', value)}
                  style={{ height: '100%', width: '100%' }}></MonacoInput>
              </div>
            )
          }
          const renderButton = () => {
