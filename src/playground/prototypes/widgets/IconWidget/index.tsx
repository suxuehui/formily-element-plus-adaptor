...
import { ElTooltip as Tooltip, ElTooltipProps as TooltipProps } from 'element-plus'
...
import { useContext } from '@pg/prototypes'
...
const __IconWidgetInner = defineComponent({
  name: 'DnIconWidget',
  props: {
    tooltip: { type: Object as PropType<TooltipProps & { content: string | VNode }> },
    ...
    return () => {
      ...
      const renderTooltips = (children: any) => {
        ...
        if (tooltip) {
          ...
          return (
            <Tooltip showAfter={200} {..._props} v-slots={{ content: () => content }}>
              {children}
            </Tooltip>
          )
        }
